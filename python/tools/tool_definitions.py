...
search_deeper_knowledge_tool_name = "search_deeper_knowledge"
...
def get_tool_definitions():
    ...
    },
    {
        "type": "function",
        "function": {
            "name": f"{search_deeper_knowledge_tool_name}",
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Get full information about the list ofspecific topics",
            "parameters": {
                "type": "object",
                "properties": {
                    "topic_ids": {
